...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const steemBalance = getBalanceNumber(useCustomTokenBalance("0x0d7c290B6761C909bb2c8E6558bdc0283432AeCf","0x76e6c698eB3F9761eB645932b2d57b5c6fe2A016"))
  ...
  const farmsList = useCallback(
    ...
    [ account, cakePrice, ethereum,steemBalance],
  )

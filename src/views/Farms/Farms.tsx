...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const activeFarms = farmsLP.filter(
    (farm) => !!farm.isTokenOnly === !!tokenMode && farm.multiplier !== '0X' && !farm.delegate && !farm.isCluster,
  )
  const inactiveFarms = farmsLP.filter(
    (farm) => !!farm.isTokenOnly === !!tokenMode && farm.multiplier === '0X' && !farm.delegate && farm.isAutoVault
  )
    ...
    <Page>
     ...
     <FarmTabButtons stakedOnly={stakedOnly} setStakedOnly={setStakedOnly} />
      ...
      <div className="mb-10" />
          ...
          <div className="grid grid-cols-2 launchpage text-left mb-10">
            <div className="p-5 leading-7 text-lg text-green2">
            <div className=" text-greenmain text-3xl leading-10 mb-4">
          Want to Launch Your Own IFO?
              ...
              <div className="mx-5 my-2 py-4 mt-12 rounded-full bg-secondary w-60 text-center text-white cursor-pointer shadow-lg">
              Apply to Launch
            </div>
            </div>
          <img src="/images/launch-project.png" alt="project" className=' ' />


          </div>
      <div className="mb-16" />
      <div className=" lg:col-start-3 col-span-1 mb-20 lg:mt-80">
            <Statistics />
          </div>
      <div className="mb-16" />
    </Page>

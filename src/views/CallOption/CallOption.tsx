        ...
        <div className="   max-h-fit calloption">
          <Flex justifyContent="space-between" marginBottom={3}>
            <Flex
              ...
              padding={2}
            >
              <img src="/images/rv2.png" alt="rv2" style={{ maxWidth: 60 }} />

              <div className="text-left mt-2">
                Call Option Amount
                <Text color='#fff' fontSize='18px' bold>
                {contbalance ? Web3.utils.fromWei(contbalance) : 0} RV2
                </Text>
              </div>
            </Flex>
          ...
          <div className="grid grid-cols-1  text-white   mb-6 ">
            ...
            <div className="grid grid-cols-5 text-center justify-items-start cog">
              <div style={{position:"relative",paddingRight:"40px"}} className="lg:ml-12 ">
                <img src="/images/rv2.png" alt="rv2" style={{ maxWidth: 50 }} />
          ...
          <div className="grid grid-cols-2 mt-2 ">
            ...
            <div className="text-right grid grid-cols-1  text-white">
              <div>{getBalanceNumber(busdBalanc, 18).toFixed(3)} RV2-BNB LP</div>
              <div>{contbalance ? Web3.utils.fromWei(contbalance) : 0} RV2</div>
              <div>$ {new BigNumber(cakePriceBusd).toFixed(3)} </div>
              <div>{minpurchase ? Web3.utils.fromWei(minpurchase) : 0} RV2</div>
            </div>
          </div>
          <br />
        </div>
